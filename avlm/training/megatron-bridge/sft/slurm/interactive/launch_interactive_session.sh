#!/usr/bin/env bash
# Start an interactive Slurm container session for Megatron-Bridge SFT.
#
...
export JOB_NAME="${JOB_NAME:-mb_sft_interactive}"
...
mb_log_section "Slurm interactive session (SFT)"
