#!/usr/bin/env bash
# Submit Megatron-Bridge SFT through Slurm. See avlm/training/megatron-bridge/sft/SFT_GUIDE.MD.
set -euo pipefail
...
echo "Megatron-Bridge SFT submit $(date '+%F %T')"
...
inference_validation_start_sbatch_watcher megatron_bridge mbridge_sft
