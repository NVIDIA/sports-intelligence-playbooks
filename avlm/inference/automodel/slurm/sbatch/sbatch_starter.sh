...
# Submit non-interactive AutoModel inference via Slurm.
set -euo pipefail
...
export INFERENCE_CONFIG MAX_INFERENCE_SAMPLES MAX_INFERENCE_SAMPLES_SEED INFERENCE_NAME_OVERRIDE BASE_OUTPUT_DIR_OVERRIDE DATA_PATH_OVERRIDE MODEL_PATH_OVERRIDE ADAPTER_PATH_OVERRIDE RESUME_OVERRIDE
...
# using training cause we have it
